...
@php
  ...
  // Contactos para edit, o old() si falló validación
  ...
  // Auto abrir Contactos si ya hay contactos o si el usuario venía enviando contactos
  $openContactos = (is_array(old('contactos')) && count(old('contactos')) > 0) || (is_array($contactos) && count($contactos) > 0);
@endphp
...
<div class="accordion soft-accordion enter-anim" id="empresaAccordion">
  ...
  <div class="accordion-item soft-card section-empresa">
    ...
    <div id="collapseEmpresa" class="accordion-collapse collapse show"
      ...
      <div class="accordion-body">
        ...
        <div class="col-md-6">
            ...
            <input
                type="text"
                class="form-control"
                value="{{ old('gestor_aapos', $gestorAapos ?? '') }}"
                readonly
            >
        </div>
        ...
        {{-- Botón rápido para ir a contactos --}}
...
{{-- ============================= --}}
{{-- JS: Agregar/Quitar contactos + animación + abrir acordeón --}}
{{-- ============================= --}}
<script>
document.addEventListener('DOMContentLoaded', () => {
  ...
  const ensureContactosOpen = () => {
    ...
    if (!el) return;
    // Bootstrap 5 Collapse API (si existe)
    if (window.bootstrap && bootstrap.Collapse) {
      const inst = bootstrap.Collapse.getOrCreateInstance(el, { toggle: false });
      inst.show();
      el.scrollIntoView({ behavior: 'smooth', block: 'start' });
    } else {
      // fallback: si no está bootstrap.js, al menos scrollea
  ...
  btnAdd?.addEventListener('click', () => {
    ...
    // abrir acordeón y enfocar primer campo
    ensureContactosOpen();
